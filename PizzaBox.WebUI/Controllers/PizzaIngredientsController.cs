...
namespace PizzaBox.WebUI.Controllers
{
    public class PizzaIngredientsController : Controller
    {
        ...
        public PizzaIngredientsController(PizzaBoxContext context)
        {
            _context = context;
        }
        ...
        {
            var pizzaBoxContext = _context.PizzaIngredients.Include(p => p.Ingredient).Include(p => p.Pizza);
        ...
        {
            ViewData["IngredientId"] = new SelectList(_context.Ingredients, "Id", "Topping");
